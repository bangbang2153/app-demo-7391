...
export default function HeaderNav(){
  ...
  return (
    <nav className="flex gap-1 sm:gap-2 items-center text-xs sm:text-sm shrink-0">
      ...
      <a href="https://wa.me/6283123768532?text=Halo%20Mashudi%20Transport%2C%20mau%20tanya%20sewa%20mobil" target="_blank" className="hidden sm:inline px-4 py-1.5 rounded-full bg-red-600 text-white font-semibold inline-flex items-center gap-1.5"><WaIcon className="w-4 h-4" /> 0831-2376-8532</a>
    </nav>
  )
}
