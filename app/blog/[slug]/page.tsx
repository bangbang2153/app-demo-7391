  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="mt-6 bg-red-50 border border-red-200 rounded-2xl p-5">
        ...
        <p className="text-sm text-gray-600 mt-1">Sewa Avanza 350K/hari atau Hiace 1.2jt — lepas kunci & dengan supir. Klik Booking, pilih tanggal harian, atau nego via WA.</p>
        <div className="mt-3 flex gap-2">
          <a href="/#katalog" className="px-5 py-2.5 rounded-full bg-red-600 text-white text-sm font-bold">Lihat Armada</a>
          <a href={`https://wa.me/6283123768532?text=${encodeURIComponent(`Halo Mashudi, habis baca blog `+post.title+`, mau sewa mobil`)}`} target="_blank" className="px-5 py-2.5 rounded-full border bg-white text-sm font-semibold">Nego WA</a>
        </div>
      </div>
